...
$cnt2=$query2->rowCount();
	...
	<a href="manage-enquires-new.php" target="_blank">
			<div class="col-md-4 four-grid">
						<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
...
$newenq=$query->rowCount();
	...
	<a href="manage-enquires-read.php" target="_blank">
						<div class="col-md-4 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
...
$cnt1=$query1->rowCount();
		...
		<a href="manage-bookings-new.php" target="_blank">
		<div class="col-md-3 four-grid">
...
$newbookings=$query->rowCount();
	...
	<a href="manage-bookings-cancel.php" target="_blank">
...
$cancelbooking=$query->rowCount();
	...
	<a href="manage-bookings-confirm.php" target="_blank">
						<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
