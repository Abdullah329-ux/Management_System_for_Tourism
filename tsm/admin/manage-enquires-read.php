...
$query->execute();
 ...
 echo "<script>window.location.href='manage-enquires-read.php'</script>";
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Enquiries</h2>
						...
						<tbody>
<?php $sql = "SELECT * from tblenquiry where (Status='1')";
$query = $dbh -> prepare($sql);
$query->execute();
...
{
	?><td>Read | 	<a href="manage-enquires-read.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Delete</a></td>
<?php } else {?>

<td><a href="manage-enquires-read.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Pending</a> | 

	<a href="manage-enquires-read.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Delete</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
