...
$sql="update hotel set hotel_IMAGE=:pimage where HOTELID =:imgid";
  ...
  <div class="grid-form1">
  	       <h3>Update Package Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT hotel_IMAGE from hotel where HOTELID =:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="pacakgeimages/<?php echo htmlentities($result->hotel_IMAGE);?>" width="200">
</div>
</div>
