...
$query->execute();
 ...
 echo "<script>window.location.href='manage-enquires-new.php'</script>";
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Enquiries</h2>
						...
						<tbody>
<?php $sql = "SELECT * from tblenquiry where (Status is null || Status='')";
$query = $dbh -> prepare($sql);
$query->execute();
...
{
	?><td>Read | 	<a href="manage-enquires-new.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Delete</a></td>
<?php } else {?>

<td><a href="manage-enquires-new.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Pending</a> | 

	<a href="manage-enquires-new.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Delete</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
