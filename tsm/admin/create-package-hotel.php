...
if(strlen($_SESSION['alogin'])==0) {	
    ...
    if(isset($_POST['submited'])) {
        ...
        $sql = "INSERT INTO hotel (hotel_Name, hotel_FOODTYPE, hotel_RATINGS, hotel_PACKAGE_TYPE, hotel_LOCATION, hotel_PRICE_IN_PKR, hotel_FEATURES, hotel_DETAILS, hotel_IMAGE)
                VALUES (:h_pname, :h_foodtype, :h_rating, :h_ptype, :h_plocation, :h_pprice, :h_pfeatures, :h_pdetails, :h_pimage)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Create Hotel Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
 
  <div class="grid-form1">
  	       <h3>Create Hotel Package</h3>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_packagename" id="h_packagename" placeholder="Enter the Hotel Name" required>
									</div>
								</div>
<div class="form-group">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_Rating" id="h_Rating" placeholder=" Hotel Rating" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_packagetype" id="h_packagetype" placeholder=" Package Type eg- Family Package / Couple Package" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_packagelocation" id="h_packagelocation" placeholder=" Hotel Location" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_packageprice" id="h_packageprice" placeholder=" Package Price is USD" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="h_packagefeatures" id="h_packagefeatures" placeholder="Hotel Features Eg-free Pickup-drop facility" required>
									</div>
								</div>		
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="h_packagedetails" id="h_packagedetails" placeholder="Hotel Details" required></textarea> 
									</div>
								</div>															
<div class="form-group">
