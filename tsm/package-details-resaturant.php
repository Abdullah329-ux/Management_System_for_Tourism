...
$comment=$_POST['comment'];
 $status=0;
$Resaturant_Package='Resaturant';
$sql="INSERT INTO tblbooking(RID,UserEmail,fromdate,Comment,status,package_category) VALUES(:pid,:useremail,:fromdate,:comment,:status,:Resaturant_Package)";
...
$query->bindParam(':Resaturant_Package',$Resaturant_Package,PDO::PARAM_STR);
...
<?php 
$pid=intval($_GET['pkgid']);
$sql = "SELECT * from restaurant where RID =:pid";
$query = $dbh->prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>Package Type :</b> <?php echo htmlentities($result->RID );?></p>
				<p><b>Package Location :</b> <?php echo htmlentities($result->ADDRESS);?></p>
					<p><b>Features</b> <?php echo htmlentities($result->Restaurant_Features);?></p>

					<div class="ban-bottom">
						<div class="bnr-right">
							<label class="inputLabel">Booking date</label>
							<!-- <input class="date" id="datepicker" type="text" placeholder="dd-mm-yyyy"  name="fromdate" required=""> -->
							Booking Date: <input type="date" class="date" id="datepicker" placeholder="dd-mm-yyyy"  name="fromdate" required>
						</div>
						<!-- <div class="bnr-right">
...
document.getElementById("datepicker1").addEventListener("change", calculateDays);
				...
				<div class="grand">
					<h3 >Rating</h3>
					<h4><?php echo htmlentities($result->RATINGS);?></h4>
				</div>
				<br><br>
			</div>
		...
		<h3>Package Details</h3>
				<p style="padding-top: 1%"><?php echo htmlentities($result->Restaurant_Details);?> </p>	
				<div class="clearfix"></div>
		</div>
		<div class="selectroom_top">
