...
$status=00;
$Hotel_Package='Hotel';
$sql="INSERT INTO tblbooking(HotelID,UserEmail,FromDate,ToDate,Comment,status,package_category) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status,:Hotel_Package)";
...
$query->bindParam(':Hotel_Package',$Hotel_Package,PDO::PARAM_STR);
...
<form name="book" method="post">
		<div class="selectroom_top">
			<div class="col-md-4 selectroom_left wow fadeInLeft animated" data-wow-delay=".5s">
				<img src="admin/pacakgeimages/<?php echo htmlentities($result->hotel_IMAGE);?>" class="img-responsive" alt="">
			</div>
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				<h2><?php echo htmlentities($result->hotel_Name);?></h2>
				<p class="dow">#PKG-<?php echo htmlentities($result->HOTELID );?></p>
				<p><b>Package Type :</b> <?php echo htmlentities($result->hotel_PACKAGE_TYPE);?></p>
				<p><b>Package Location :</b> <?php echo htmlentities($result->hotel_LOCATION);?></p>
					<p><b>Features</b> <?php echo htmlentities($result->hotel_FEATURES);?></p>
...
function calculateDays() {
    ...
    const endDate = new Date(document.getElementById("datepicker1").value);
       ...
       var getwhole_date= document.getElementById("result").innerHTML =(dayDifference+1)*<?php echo htmlentities($result->hotel_PRICE_IN_PKR);?> + " PKR.";
...
document.getElementById("datepicker1").addEventListener("change", calculateDays);
		...
		<h3>Package Details</h3>
				<p style="padding-top: 1%"><?php echo htmlentities($result->hotel_DETAILS);?> </p>	
				<div class="clearfix"></div>
		</div>
		<div class="selectroom_top">
			<h2>Hotel Booking</h2>
				...
				<div id="map" style="height: 300px; width: 220%; background-color: #f0f0f0;">
					<tr>
						...
						<td style="width: 450px; height: 450px;">
							<iframe src='https://maps.google.com/maps?q=<?php echo $result->hotel_Latitude; ?>,<?php echo $result->hotel_Longitude; ?>&h1=es;z=14&output=embed' style="width:100%; height:100%">
							</iframe>
						</td>
					</tr>
			    </div>        
